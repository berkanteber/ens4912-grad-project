...
int main()
{
  ...
  ofstream full_out("gindexes-wself.txt");
  ...
  full_out.close();
  cout << "gindexes-wself.txt has been written." << endl;
  ...
  ofstream top_out("top10000-g-wself.txt");
  ...
  top_out.close();
  cout << "top10000-g-wself.txt has been written." << endl;
