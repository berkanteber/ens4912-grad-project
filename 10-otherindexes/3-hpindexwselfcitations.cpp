...
int main()
{
  ...
  ifstream hindexes_in("../00-data/06-hindex/hindexes-wself.txt");
  ...
  ofstream full_out("hprimes-wself.txt");
  ...
  full_out.close();
  cout << "hprimes-wself.txt has been written." << endl;
  ...
  ofstream top_out("top10000-hp-wself.txt");
  ...
  top_out.close();
  cout << "top10000-hp-wself.txt has been written." << endl;
