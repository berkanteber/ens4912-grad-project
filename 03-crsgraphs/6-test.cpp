...
int main()
{
  ...
  ifstream rowptr_in("../0-data/3-crs/author_collaborates_author_rowptr.txt");
  ...
  cout << "author_collaborates_author_rowptr.txt has been read." << endl;

  ifstream colind_in("../0-data/3-crs/author_collaborates_author_colind.txt");
  ...
  cout << "author_collaborates_author_colind.txt has been read." << endl;

  ifstream weights_in("../0-data/3-crs/author_collaborates_author_weights.txt");
  ...
  cout << "author_collaborates_author_weights.txt has been read." << endl;
